...
For my quick tutorial we'll be using crime data from the city of Pittsburgh. The file we'll start with is called [nicar17_unix.csv](https://github.com/AJVicens/favcommandlinetools/blob/master/nicar_cli_2017.md). To get the raw data, click on the file name in the main repo, click `Raw` to get the raw data, and then save-as with whatever file name you want in the `.csv` format.
