...
For my quick tutorial we'll be using crime data from the city of Pittsburgh (the file we'll start with is in this repo [above] at(). The data set includes various codes used by the city, location data, crime codes, and other information that could come in handy depending on what you're trying to do. You could always open Excel to peek at your data: 
